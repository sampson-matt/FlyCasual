...
namespace Abilities.SecondEdition
{
    public class CompassionAbility : GenericAbility
    {
        ...
        {
            if (HostShip.State.Force > 0 && Combat.CurrentCriticalHitCard.IsFaceup && Combat.CurrentCriticalHitCard.Type == CriticalCardType.Pilot && Tools.IsAnotherFriendly(HostShip, ship) && BoardTools.Board.IsShipBetweenRange(HostShip, ship, 0, 2))
            {
        ...
        private void UseCompassionAbility(object sender, System.EventArgs e)
        {
