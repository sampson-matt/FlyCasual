...
{
    public class SensorJammerBoY : GenericUpgrade
    {
        public SensorJammerBoY() : base()
        {
            IsHidden = true;
...
namespace Abilities.SecondEdition
{
    public class SensorJammerAbility : GenericAbility
    {
        ...
        {
            GenericAction newAction = new SensorJammerBoYActionEffect()
            {
...
{
    public class SensorJammerBoYActionEffect : GenericAction
    {

        public SensorJammerBoYActionEffect()
        {
